...
Subcommands: pie, bar, line, combo, grouped_bar
"""
...
def cmd_pie(args):
    ...
    if labels:
        legend_labels = [f"{l} (${v:.0f}M)" for l, v in zip(labels, values)]
...
def main():
    ...
    parser.add_argument("subcommand", choices=["pie", "bar", "line", "combo", "grouped_bar"],
                        help="Chart type")
